...
//создается конфиг txt файл при первой загрузке игры, дает возможность поменять количество доп противников в волне waveRandomFactor и кулдаун между волнами
[System.Serializable]
